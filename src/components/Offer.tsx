...
const Offer = () => {
  return (
    <div className="bg-black h-screen flex flex-col md:flex-row md:jsutify-between md:bg-[url('/offerBg.png')] md:h-[70vh]">
      {/*TEXT CONTAINER*/}
      <div className='flex-1 text-white flex flex-col justify-center items-center text-center gap-8 p-6'>
        <h1 className='text-5xl xl:text-6xl'>Delicious Burger & French Fry</h1>
